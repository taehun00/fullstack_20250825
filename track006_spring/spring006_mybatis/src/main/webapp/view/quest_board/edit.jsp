...
<%@include file="../inc/header.jsp" %>
	...
	$(function(){
		...
		if(result == "수정 실패"){ alert(result); location.href='list.quest'; }
     ...
     <input type="hidden"   name="id"  value="${dto.id}">
	  ...
	  <div class="mb-3">
	    ...
	    <input type="password" class="form-control" id="bpass" 
	    	placeholder="비밀번호를 입력해주세요" name="bpass" value="${dto.bpass}">
	  </div>
	  <div class="mb-3">
	    <label for="bcontent" class="form-label">CONTENT:</label>
	    <textarea class="form-control" id="bcontent" placeholder="내용을 입력해주세요" name="bcontent" value="${dto.bcontent}"></textarea>
	  </div> 
	  <div class="mb-3">
